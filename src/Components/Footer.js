    ...
    <footer>
      <div className="wrapper footer-container">
        ...
        <motion.div
          ...
          <a className="footer-social-icon-box" href={resume} title="download resume" download="fiona-freemark-resume.pdf" target="_blank" rel='noreferrer' ><FaFileDownload className="footer-social-icon" /></a>
        </motion.div>
      </div>
    </footer>
  )
