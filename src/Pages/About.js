      ...
      <section className="about-me-section">
        <div className="about-me-container wrapper">
          <div className="about-me-text-container">
            <animated.h3 style={fade300} className="about-me-heading">About Me</animated.h3>
          ...
          <animated.div style={fade500} className="about-me-img-container">
            <img className="fiona-portrait" src={Fiona}
              alt="Portrait of Fiona Freemark, the developer of this website." />
          </animated.div>
        </div>
        <animated.div style={fade300} className="scroll-btn">
          <a href="#skills">
